  ...
  class Calendar {
    ...
    **/
    private function _showDay($cellNumber) {
      ...
      $today_mon = date("m");
      $today_yea = date("Y");
      // Calendar cell for today
      if($cellContent == $today_day && $this->currentMonth == $today_mon && $this->currentYear == $today_yea) {
        $class_day = "calendar_today";
      }
      // Calendar cell for past days
      elseif ($cellContent < $today_day && $this->currentMonth <= $today_mon && $this->currentYear <= $today_yea) {
        $class_day = "calendar_pastdays";
      }
      else {
        $class_day = "calendar_days";
      }
      return '<li class="' . $class_day . '"> <a href="choose_class.php?date=' . $this->currentDate . '">' . $cellContent . '</a></li>' . "\r\n";
    }
    /**
    ** create navigation
    **/
