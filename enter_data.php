...
if ($stmt->rowCount()) {
	while ($row = $stmt->fetch())
	{
		echo "<tr><td>" . htmlspecialchars($row['student_id'], ENT_QUOTES, 'UTF-8') . "</td>
				...
				<td><select id=\"speaking\" name=\"adata[" . htmlspecialchars($row['student_id'], ENT_QUOTES, 'UTF-8') . "][speaking]\">
				...
				<td><textarea name=\"adata[" . htmlspecialchars($row['student_id'], ENT_QUOTES, 'UTF-8') . "][notes]\" cols=\"30\" rows=\"2\"></textarea></td>";
	}
}
else {
